...
const sendEmail = (e) => {
    ...
    if (contactName.value === '' || contactEmail.value === '' || contactProject.value === '') {
        ...
        contactMessage.textContent = "Prencha todos os campos"
    } else {
        contactMessage.classList.add('color-green')
        contactMessage.textContent = 'Enviando...'
        emailjs.sendForm('service_bosphoa', 'template_a7to96h', '#contact-form', 'HghryTZ9FlxYcu4xJ')
            .then(() => {
                ...
                contactMessage.classList.remove('color-green')
                contactMessage.classList.add('color-red')
                contactMessage.textContent = 'Mensagem não enviada. Erro codigo->' + error.status
            })
    }
}
